...
class _LoginState extends State<Login> {
  ...
  void _loginHandler(String username, String password) {
    setState(() {
      isLoading = true;
    });
        ...
        child: Stack(
          ...
          children: [
            isLoading
                ...
                : const SizedBox.shrink(/* this returns empty widget for the sake of the ternary condition */),
            Center(
              child: Column(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  _loginHandler(username, password);
